      ...
      <AuthBackground className='dark font-[430] font-season text-white'>
        <div className='mx-auto flex min-h-screen max-w-xl items-center px-6 py-16'>
          <div className='w-full rounded-[24px] border border-white/10 bg-black/45 p-8 backdrop-blur-md'>
            <p className='text-white/55 text-xs uppercase tracking-[0.24em]'>Spex AI Access</p>
            <h1 className='mt-4 text-3xl text-white leading-tight'>Open the builder from Spex.</h1>
            <p className='mt-4 text-sm text-white/70 leading-6'>
              Native SIM login is disabled for this deployment. Use the HeySpex app or Spex website
              with your verified email to enter the workflow builder.
            </p>
            <div className='mt-6'>
